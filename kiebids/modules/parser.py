...
def read_xml(file_path: str) -> dict:
    ...
    for page in root.findall(".//ns:Page", namespaces=ns):
        ...
        for text_region in text_regions:
            ...
            text = text_region.findall(".//ns:TextEquiv", namespaces=ns)
            text = text[-1]

            text = text.find(".//ns:Unicode", namespaces=ns).text if text else ""
